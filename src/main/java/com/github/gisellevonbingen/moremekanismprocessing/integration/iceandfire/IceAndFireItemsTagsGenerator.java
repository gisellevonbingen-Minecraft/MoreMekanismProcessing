...
public class IceAndFireItemsTagsGenerator extends ItemTagsProvider
{
	public IceAndFireItemsTagsGenerator(DataGenerator p_i244817_1_, BlockTagsProvider p_i244817_2_, ExistingFileHelper p_i244817_4_)
	{
