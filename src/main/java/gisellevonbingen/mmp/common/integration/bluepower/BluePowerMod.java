...
public class BluePowerMod extends IntegrationMod
{
	...
	public void addItemTags(IntegrationItemTagsGenerator generator)
	{
		...
		generator.tagOres(MaterialState.RAW_ITEM.getStateItemTag(MaterialType.SILVER), SILVER_RAW_ITEM);
		generator.tagOres(MaterialState.RAW_ITEM.getStateItemTag(MaterialType.ZINC), ZINC_RAW_ITEM);
		generator.tagOres(MaterialState.RAW_ITEM.getStateItemTag(MaterialType.TUNGSTEN), TUNGSTEN_RAW_ITEM);
	}
